package com.resource.server.commons;
...
public class RedisLock {
	...
	public static String tryLock(String lockName, String releaseTime) {
		...
		// 执行脚本
		Long result = redisTemplate.execute(LOCK_SCRIPT, Collections.singletonList(lockName),
	...
	public static void unlock(String lockName, String key) {
		// 执行脚本
		redisTemplate.execute(UNLOCK_SCRIPT, Collections.singletonList(lockName), key + Thread.currentThread().getId(),
				null);
	}
}
